...
# from Pipeline.config import path_to_endonuke_data_folder
...
path_to_endonuke_data_folder = parent_path / "Datasets/Endonuke/data"
print(path_to_endonuke_data_folder)

def preprocess_endonuke():
