...
class GanDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        B_path = self.B_paths[self.B_index % self.B_size]
        self.B_index += 1
        ...
        random_index = random.randint(0, min(len(A_patches), len(B_patches)))
        ...
        return {'A': A_patch, 'B': B_patch, 'A_img': A_img, 'B_img': B_img, 'A_index': index, 'B_index': self.B_index -1, 'B_initial_index': B_initial_index, 'patch_index': random_index}


x = r'/home/jotapv98/coding/MyProjects/GenAI_HE_IHC/BCI_dataset/HE/train'
y = r'/home/jotapv98/coding/MyProjects/GenAI_HE_IHC/BCI_dataset/IHC/test'
