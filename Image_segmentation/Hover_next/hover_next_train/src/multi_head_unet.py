...
def get_model(
    ...
    # out_channels_cls=8, #AZ: No vamos a hacer classification
    out_channels_inst=5,
    pretrained=True,
):
    pre_path = None
    ...
    # decoders = [decoder_inst, decoder_ct] #AZ: codigo original
    decoders = [decoder_inst] #AZ: codigo modificado
    # heads = [head_inst, head_ct] #AZ: codigo original
    heads = [head_inst] #AZ: codigo modificado
