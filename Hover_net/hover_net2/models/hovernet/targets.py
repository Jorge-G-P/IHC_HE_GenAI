...
def gen_instance_hv_map(ann, crop_shape):
    ...
    # Convert crop_ann to boolean array
    crop_ann_bool = crop_ann.astype(bool)
    
    # Apply remove_small_objects on the boolean array
    crop_ann_bool = morph.remove_small_objects(crop_ann_bool, min_size=30)
    
    # Restore original labels
    crop_ann = crop_ann * crop_ann_bool
