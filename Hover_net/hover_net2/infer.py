...
#from data_prep import directory_name_test
...
# path_to_Hover_net_run_infer = parent_path / "Hover_net/hover_net2/run_infer.py/"
...
#     '--model_mode=fast',
#     'tile',
#     '--input_dir='+directory_test,
#     '--output_dir='+hover_results_folder,
#     '--draw_dot'
# ]
