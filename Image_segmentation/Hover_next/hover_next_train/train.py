...
# from src.focal_loss import FocalLoss, FocalCE #AZ: no necesario
...
def supervised_training(params):
    ...
    model = get_model(
        enc=params["encoder"],
        # out_channels_cls=params["out_channels_cls"], #AZ: no necesario
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="sample_configs/train_pannuke.toml",
